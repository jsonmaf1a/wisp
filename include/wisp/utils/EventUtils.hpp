...
namespace wisp::EventUtils
{
    static constexpr bool isMouseEvent(const sf::Event &event)
    {
        return event.is<sf::Event::MouseMoved>() || event.is<sf::Event::MouseButtonPressed>() ||
    ...
    static constexpr bool isLeftClickEvent(const sf::Event &event)
    {
        ...
        return mouseClickEvent && mouseClickEvent->button == sf::Mouse::Button::Left;
    }
} // namespace wisp::EventUtils
